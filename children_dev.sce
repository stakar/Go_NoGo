...
#array<bitmap>go_objects[] = {go_stimuli_pic};
...
instrukcja_blok_pic.add_part(graphics_no_go[y],300,-180);
instrukcja_blok_pic.add_part(graphics_go[y ],-300,-180);
...
begin
	...
	instrukcja_blok_pic.add_part(graphics_no_go[current_go],300,-180);
	instrukcja_blok_pic.add_part(graphics_go[current_go],-300,-180);
	instrukcja_blok_trial.present();
